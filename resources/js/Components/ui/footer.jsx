export default function Footer({ textDos, text, link }) {
    return (
        <div className="px-12 py-6 bg-gray-50 border-t border-gray-200 flex flex-col justify-between items-center dark:bg-gray-900 ">
            ...
            <div className="text-m text-gray-500 dark:text-white text-center">
